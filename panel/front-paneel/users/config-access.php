                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group mb-3" style="direction: ltr;">
                            <input type="text" class="form-control" name="title" style="direction: rtl;" placeholder="لطفا عنوان مجوز را وارد نمایید" aria-label="Recipient's username" aria-describedby="basic-addon2" value=""  required>
                            <span class="input-group-text" id="basic-addon2"style="width: 210px;">عنوان مجوز | سمت در سیستم</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group mb-3" style="direction: ltr;">
                            ...
                            <span class="input-group-text" id="basic-addon2"style="width: 114px;">وضعیت مجوز</span>
                        </div>
                    </div>
                </div>
