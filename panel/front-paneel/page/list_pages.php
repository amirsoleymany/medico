...
<table class="table table-striped table-advance table-hover">
    ...
    <tr>
        ...
        <th>تاریخ</th>
        <th>وضعیت</th>
        <?php /*if(strpos($select_permitions->permition,'edit_page.php') !==false): */?>
        <th>ویرایش</th>
        <?php /*endif; */?><!--
        --><?php /*if(strpos($select_permitions->permition,'delete-page.php') !==false): */?>
        <th>حذف</th>
        <?php /*endif; */?>
    ...
    if(count($page) == 0):
        ...
        <div class="alert alert-danger" role="alert">
            ...
            هنوز هیچگونه صفحه ای در سیستم ایجاد نشده است ...
        </div>
    <?php endif; ?>
    <?php
    foreach ($page as $index=>$val) :
        ?>
        <tr>
            <td><?php echo $index+1; ?></td>
            <td><button type="button" class="btn btn-outline-dark" ><?php echo $val->code_page ?></button></td>
            <td><?php echo $val->title ?></td>
            <td>
                <?php
                $title_groupe_page = select_groupe_page($val->id_groupe);
                echo $title_groupe_page->title;
                ?>
            </td>
            ...
            <?php /*if(strpos($select_permitions->permition,'edit_page.php') !==false): */?>
            <td><a href="dashboard.php?page=setting_page&id_page=<?php echo $val->id; ?>"  class="btn btn-primary btn-xs">
            ...
            <?php /*if(strpos($select_permitions->permition,'delete-page.php') !==false): */?>
            <td><a href="dashboard.php?page=delete-page&id=<?php echo $val->id; ?>" class="btn btn-danger btn-xs">
...
<?php /*else:*/?><!--
    <div class="alert alert-danger alert-dismissible fade show" style="line-height: 28px;" role="alert">
        <strong>کاربر محترم!<br></strong> شما به بخش لیست صفحات ایجاد شده دسترسی ندارید
